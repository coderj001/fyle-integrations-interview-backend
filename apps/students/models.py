...
class Student(models.Model):
    ...
    user = models.OneToOneField(
        User, on_delete=models.CASCADE, help_text="Reference to User model"
    )
...
class Assignment(models.Model):
    ...
    student = models.ForeignKey(
        Student, on_delete=models.CASCADE, help_text="Reference to Student model"
    )
    ...
    state = models.CharField(
        max_length=9,
        choices=ASSIGNMENT_STATE_CHOICES,
        default="DRAFT",
